...
// Common icon components using the Svg wrapper
...
export function ExclamationTriangleIcon(props: SvgProps) {
  return (
...
export function InformationCircleIcon(props: SvgProps) {
  return (
    <Svg viewBox="0 0 24 24" {...props}>
      <path
        fillRule="evenodd"
...
export function CopyIcon(props: SvgProps) {
  return (
    <Svg viewBox="0 0 24 24" {...props}>
      ...
      <path d="M15 5.25a5.23 5.23 0 00-1.279-3.434 9.768 9.768 0 016.963 6.963A5.23 5.23 0 0017.25 7.5h-1.875A.375.375 0 0115 7.125V5.25zM4.875 6H6v10.125A3.375 3.375 0 009.375 19.5H16.5v1.125c0 1.036-.84 1.875-1.875 1.875h-9.75A1.875 1.875 0 013 20.625V7.875C3 6.839 3.84 6 4.875 6z" />
    </Svg>
  )
}
...
export function MonitorIcon(props: SvgProps) {
  return (
    <Svg
      viewBox="0 0 24 24"
      fill="none"
